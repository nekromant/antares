...
#include "include/global.h"		// include our global settings
#include "include/cmdline.h"

// include project-specific configuration
// #include "include/cmdlineconf.h"
...
// strings
u08 PROGMEM CmdlinePrompt[] = CONFIG_AVRLIB_CMDLINE_PROMPT;
u08 PROGMEM CmdlineNotice[] = CONFIG_AVRLIB_CMDLINE_NOTICE;
u08 PROGMEM CmdlineCmdNotFound[] = CONFIG_AVRLIB_CMDLINE_NOTFOUND;

// command list
// -commands are null-terminated strings
static char CmdlineCommandList[CONFIG_AVRLIB_CMDLINE_MAX_COMMANDS][CONFIG_AVRLIB_CMDLINE_MAX_CMD_LENGTH];
// command function pointer list
static CmdlineFuncPtrType CmdlineFunctionList[CONFIG_AVRLIB_CMDLINE_MAX_COMMANDS];
// number of commands currently registered
u08 CmdlineNumCommands;

u08 CmdlineBuffer[CONFIG_AVRLIB_CMDLINE_BUFFERSIZE];
u08 CmdlineBufferLength;
u08 CmdlineBufferEditPos;
u08 CmdlineInputVT100State;
u08 CmdlineHistory[CONFIG_AVRLIB_CMDLINE_HISTORYSIZE][CONFIG_AVRLIB_CMDLINE_BUFFERSIZE];
...
int cmdlineGetArgInt(u08 argnum)
{
	char* endptr;
	//return 
	return (int) strtol((char*)cmdlineGetArgStr(argnum), &endptr, 10);
}
